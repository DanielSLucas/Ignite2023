/*
  WatchedList Pattert (Lista observada)
  Nesse pattern os items de uma lista são observados: quais são os items, inciais,
  quais foram adicionados e quais foram removidos, além do estado atual da lista.

  Facilitando a manipulação de agregados, como os anexos de uma questão.
  *Ver tests automatizados para entender melhor seu funcionamento
*/
